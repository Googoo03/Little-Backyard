...
public class Octree<TType>
{
    ...
    public class OctreeNode<OctreeNodeTType>

    {
        Vector3 position;
        float size;
        OctreeNode<OctreeNodeTType>[] subNodes;
        IList<OctreeNodeTType> value;
        ...
        public IEnumerable<OctreeNode<OctreeNodeTType>> Nodes
...

        {
            ...
            subNodes = new OctreeNode<OctreeNodeTType>[8];
...

            {
                ...
                subNodes[i] = new OctreeNode<OctreeNodeTType>(newPos, size * 0.5f);
