...
namespace Simplex
{
    ...
    public class Noise
    {
        ...
        public void CreateTexture3D(int resolution, int octaves, float frequency, float lacunarity, float persistence, float amplitude)
        {
            ...
            UnityEditor.AssetDatabase.CreateAsset(texture, "Assets/Example3DPerlinTexture.asset");
        }
